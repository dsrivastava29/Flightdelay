...
public class AirlineTextPair implements WritableComparable {
	...
	public int compareTo(Object object) {
		...
		cmp = getMonth().compareTo(ip2.getMonth());
		return cmp;
	}
	...
	public boolean equals(Object o) {
		...
		return (this.airLineName.equals(p.getAirLineName()) && (this.month.equals(p.getMonth())));
	}
	...
	public String toString() {
		return (new StringBuilder().append(airLineName).append(",").append(month)).toString();
	}
}
